...
use App\Models\Validators\PersonneValidator;

require_once __DIR__ . '/Model.php';

/**
 * Modèle représentant la table personne et fournissant les opérations CRUD.
 */
class Personne extends Model
{
    protected static ?string $validatorClass = PersonneValidator::class;
    protected static string $table = 'personnes';
    protected static string $primaryKey = 'id_personne';
