...
--
--
-- Event quotidien des statistiques desactive pour compatibilite production.
-- Raison: droits EVENT souvent limites en hebergement mutualise.
-- Si necessaire, creer l evenement manuellement apres deploiement.
-- Seed data script.
